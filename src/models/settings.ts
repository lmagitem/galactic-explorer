...
export interface UniverseSettings {/// The specific universe [StelliferousEra] to use if any. Will be overwritten if the age or **use_ours** is set.
...
export interface GalaxySettings {/// The specific [GalacticNeighborhoodDensity] if any.
